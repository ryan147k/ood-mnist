...
dataset_id=0
batch_size=1024
CUDA_VISIBLE_DEVICES=2 nohup python -u main.py --batch_size=${batch_size} --debug=False --ex_num=${ex_num} --dataset_id=${dataset_id} > log/ex${ex_num}_${dataset_id}.log 2>&1 &
